...
import com.github.oopsjpeg.osu4j.backend.EndpointScores.Arguments;
...
public class EndpointScores implements Endpoint<Arguments, List<OsuScore>> {
    public static class Arguments {
        ...
        public Arguments(ArgumentsBuilder builder) {
            ...
            builder.mods.ifPresent(mods -> arguments.put("mods", Integer.toString(mods.asInt())));
    ...
    public static class ArgumentsBuilder implements ArgumentBuilder<Arguments> {
        ...
        private Optional<GameMods> mods = Optional.empty();
    ...
    private static String API_ENDPOINT = "/api/get_scores";

    private final APIAccess api;

    public EndpointScores(APIAccess api) {
        this.api = api;
    }
